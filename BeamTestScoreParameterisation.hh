...
//
#ifndef BEAMTESTSCOREPARAMETERISATION_HH
#define BEAMTESTSCOREPARAMETERISATION_HH
...
class BeamTestScoreParameterisation : public G4VPVParameterisation {

public:
  
  // Constructor
  BeamTestScoreParameterisation(const G4double minRadius, const G4double maxRadius, 
				const G4double deltaTheta);
  
  // Destructor
  virtual ~BeamTestScoreParameterisation();
